...
export const FIXED_COMMANDS: CmdDef[] = [
  ...
  { name: "/subextract", descKey: "cmd.subextract" },
  { name: "/legextrair", descKey: "cmd.subextract" },
  { name: "/subconvert", descKey: "cmd.subconvert" },
  { name: "/legconverter", descKey: "cmd.subconvert" },
